  ...
  return (
    <section id="about" className="w-full py-20 md:py-32 px-4 bg-secondary/30">
      <div className="max-w-6xl mx-auto">
        ...
        <Card className="p-8 border-border/50 hover:border-primary/50 transition-colors mb-12">
        ...
        <Card className="p-8 bg-gradient-to-r from-primary/10 to-accent/10 border-border/50">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              <p className="text-4xl font-bold text-primary mb-2">Mañana y Tarde</p>
              <p className="text-muted-foreground">Horarios flexibles</p>
            </div>
            <div>
              <p className="text-4xl font-bold text-primary mb-2">Nivelación</p>
